...
CREATE OR REPLACE PUBLIC SYNONYM NOTIFICATIONS_ARCHIVE FOR NOTIFY.NOTIFICATIONS_ARCHIVE;

GRANT SELECT,INSERT,UPDATE,DELETE ON NOTIFICATIONS_ARCHIVE TO NOTIFY_USER;
...
CREATE OR REPLACE PUBLIC SYNONYM NOTIFICATION_USERS_ARCHIVE FOR NOTIFY.NOTIFICATION_USERS_ARCHIVE;

GRANT SELECT,INSERT,UPDATE,DELETE ON NOTIFICATION_USERS_ARCHIVE TO NOTIFY_USER;
